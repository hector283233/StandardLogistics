...
MSG_BA_NOT_FOUND = "Business account not found."
MSG_BA_EXISTS = "Business account for current user already exists."
MSG_DATA_NOT_VALID = "Input values are not valid."
MSG_NOT_BELONG_TO_USER = "Current object does not belong to current user."
MSG_OBJECT_DELTED = "Object successfully deleted."
